...
public class BookEditController
{
    ...
    public void setLibraryBook(LibraryBook libraryBook)
    {
        ...
        titleField.setText(libraryBook.getBook().getTitle());
        authorField.setText(libraryBook.getBook().getAuthor());
        numberOfPagesField.setText(String.valueOf(libraryBook.getBook().getNumberOfPages()));
        copyrightField.setText(String.valueOf(libraryBook.getBook().getCopyright()));
    ...
    private void handleOk()
    {
        if(isInputValid())
        {
            libraryBook.getBook().setTitle(titleField.getText());
            libraryBook.getBook().setAuthor(authorField.getText());
            libraryBook.getBook().setNumberOfPages(Integer.parseInt(numberOfPagesField.getText()));
            libraryBook.getBook().setCopyright(Integer.parseInt(copyrightField.getText()));
